...
// Checkin $Date: June 2, 2006   11:10:18 $
//###########################################################################
//
...
#if FLASH_F2809
// All sectors on an F2809 - Sectors A - H
#define SECTOR_F2809  (SECTORA|SECTORB|SECTORC|\
                       SECTORD|SECTORE|SECTORF|\
                       SECTORG|SECTORH)
#endif // -- end FLASH_F2809
...
#elif FLASH_F2809
#define Flash_Erase(a,b)          Flash2809_Erase(a,b)
#define Flash_Program(a,b,c,d)    Flash2809_Program(a,b,c,d)
#define Flash_Verify(a,b,c,d)     Flash2809_Verify(a,b,c,d)
#define Flash_ToggleTest(a,b)     Flash2809_ToggleTest(a,b)
#define Flash_DepRecover()        Flash2809_DepRecover()
#define Flash_APIVersionHex()     Flash2809_APIVersionHex()
#define Flash_APIVersion()        Flash2809_APIVersion()
#endif
...
#endif // -- end FLASH280X_API_LIBRARY_H 
